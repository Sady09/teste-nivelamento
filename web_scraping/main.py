...
if anexo_1 and anexo_2:
    ...
    anexo1_filename = os.path.join('./downloads', 'Anexo_I_Rol_2021RN_465.2021_RN627L.2024.pdf')
    anexo2_filename = os.path.join('./downloads', 'Anexo_II_DUT_2021_RN_465.2021_RN628.2025_RN629.2025.pdf')
